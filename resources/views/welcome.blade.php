                        ...
                        <div class="slider_block" style="background-image: url(images/banner_slide01.png);">
                            <div class="ban_text ">
                                <div class="inner_text">
                                    ...
                                    <p class="lead">We Only Serve Real Steaks, The steak you will always remember.
                                    </p>
                        ...
                        <div class="slider_block" style="background-image: url(images/banner_slide03.png);">
                            <div class="ban_text">
                                <div class="inner_text">
                                    ...
                                    <p class="lead">Authentic Tastes & Authentic Atmosphere, Change your life with
                                        our steaks. </p>
                                    <a href="menu-list-1.html" class="btn btn_primary">view our full menu</a>
                                </div>
                            </div>
            ...
            <div class="container">
                <ul class="count_block" id="counter">
                    ...
                    <li data-aos="fade-up" data-aos-duration="1500">
                        ...
                        <p class="count_text"><span class="counter-value" data-count="25">0</span><span>+</span></p>
                        <p>Passonate Chefs</p>
                    </li>
                    <li data-aos="fade-up" data-aos-duration="2000">
                        <div class="icon"><img src="images/dish_fav.png" alt="img"></div>
                        <p class="count_text"><span class="counter-value" data-count="125">0</span><span>+</span></p>
        ...
        <section class="our_menu_section row_inner_am light_texchur">
            ...
            <div class="container">
                ...
                <div class="tab-content" id="myTabContent" data-aos="fade-up" data-aos-duration="1500">
                                    ...
                                    <div class="dish_box">
                                        <div class="dish_info">
                                            ...
                                            <div class="dish_text">
                                                ...
                                                <p>Tomatoes Beef, Eggs, poached Beef, Eggs, poached, with bacon, Bacon,
                                    ...
                                    <div class="dish_box">
                                        ...
                                        <div class="dish_info">
                                            ...
                                            <div class="dish_text">
                                                ...
                                                <p>Shad angler arapaima pencilsmelt. Eggs, poached, with Galjoen fish
                                    ...
                                    <div class="dish_box">
                                        ...
                                        <div class="dish_info">
                                            ...
                                            <div class="dish_text">
                                                ...
                                                <p>Roasted roma tomatoes mushrooms & spinach Beef, Eggs, poached, fried,
                                                    with bacon, chorizo.
                                                </p>
                                    ...
                                    <div class="dish_box">
                                        <div class="dish_info">
                                            ...
                                            <div class="dish_text">
                                                ...
                                                <p>Shad angler arapaima pencilsmelt. Eggs, poached, fried, with bacon.
                                        ...
                                        <div class="dish_info">
                                            ...
                                            <div class="dish_text">
                                                ...
                                                <p>Bacon, chorizo, roasted roma
                                                    tomatoes Beef, Eggs, poached Beef, Eggs, poached, with bacon, </p>
                                                <span class="price">$22.00</span>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- Tab Block -->
                    <div class="tab-pane fade show active" id="steaks" role="tabpanel"
                        aria-labelledby="steaks-tab">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="dish_box">
                ...
                <div class="section_title text-center" data-aos="fade-up" data-aos-duration="1500">
                    ...
                    <h2>A restaurant with Timeless & Traditional taste <br> <span class="heading_img"><img
                        ...
                        The steak you will always remember. <span class="heading_img"><img src="images/who_icon2.png"
                                alt="img"></span> Let us <br> change your life with our steaks.
                    </h2>
                </div>
            </div>
            <!-- Image Gallery Start-->
                ...
                <div class="form_inner" data-aos="fade-in" data-aos-duration="1500" data-aos-delay="150">
                    <div class="formBlock">
                        <div class="text-center">
                            ...
                            <p>Booking request <a href="tel:+88123123456">+88-123-123456</a> or fill out the order form
                            </p>
                        </div>
                        <form>
                            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="blog_card" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <div class="info">
                                ...
                                <h3><a href="blog-list.html">Satisfying your steak needs one bite at a time.</a></h3>
                                <a href="blog-list.html" class="btn btn_text">READ MORE <i
                                        class="icofont-long-arrow-right"></i></a>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 copy_right text-center">
                        <p>© 2023 Restaurant. All Rights Reserved | Crafted by <a
                                href="https://themeforest.net/user/kalanidhithemes" target="blog-list">Kalanidhi
                                Themes</a></p>
                    </div>
                </div>
            </div>
