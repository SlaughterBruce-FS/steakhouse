                                                ...
                                                <div class="d-flex">
                                                    <div>
                                                        <img alt="avatar" class="img-fluid " style="width: 100px"
                                                            src="{{ asset('storage/images/' . $discount->image) }}">
                                                    </div>
                                                </div>
                                            </td>
                                            <td> {{ $discount->title }}</td>
                                            <td>{{ $discount->percent_off }}</td>
                                            <td>{{ number_format($discount->amount_off, 2) }}</td>
                                            <td>{{ $discount->price }}</td>
                                            {{--  <td>{{ $discount->description }}</td>  --}}
                                            <td>{{ $discount->status }}</td>
                                            {{--  <td>{{ $discount->food->name }}</td>  --}}
                                            <td>{{ $discount->code }}</td>
                                            <td>{{ $discount->created_at }}</td>
                                            <td class="text-center ">
                                                <a class="badge badge-light-primary text-start me-2 action-edit"
                                                    href="{{ route('discount.edit', ['id' => $discount->id]) }}"><svg
                                                ...
                                                <a class="badge badge-light-danger text-start action-delete"
                                                    href="{{ route('discount.destroy', ['id' => $discount->id]) }}"
