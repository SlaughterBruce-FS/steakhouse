        ...
        <div class="layout-px-spacing">
            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="row mb-4 layout-spacing layout-top-spacing">
                    <form class="row" method="POST" action="{{ route('discount.store') }}"
                        ...
                        col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="widget-content widget-content-area blog-create-section">
                                    ...
                                    <div class="form-group row invoice-created-by">
                                        ...
                                        <div class="col-sm-12">
                                            <label for="payment-method-country"
                                                class="col-sm-12 col-form-label col-form-label-sm">If Meal Choose
                                                meal</label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="payment-method-country"
                                            class="col-sm-12 col-form-label col-form-label-sm">Title</label>
                                        <input type="text" class="form-control" id="title"
                                            placeholder="Tuesday Special" name="title">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="payment-method-country"
                                            class="col-sm-12 col-form-label col-form-label-sm">Percent off</label>
                                        <input type="text" class="form-control" id="percent_off" placeholder="20"
                                            name="percent_off">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="payment-method-country"
                                            class="col-sm-12 col-form-label col-form-label-sm">Amount off</label>
                                        <input type="text" class="form-control" id="amount_off" placeholder="10.00"
                                            name="amount_off">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <label for="payment-method-country"
                                            class="col-sm-12 col-form-label col-form-label-sm">Descriptioin</label>
                                        <input type="text" class="form-control" id="description"
                                            placeholder="Enjoy $5 off your next meal " name="description">
                                    </div>
                                </div>
                                {{--  <div class="row mb-4">
                                    <div class="col-sm-12">
