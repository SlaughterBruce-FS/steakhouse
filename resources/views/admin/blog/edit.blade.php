            ...
            <div class="middle-content container-xxl p-0">
                ...
                <div class="row layout-top-spacing">
                    ...
                    <form class="row" method="POST"
                        action="{{ route('blogs.update', ['id' => $blogs->id, 'slug' => $blogs->slug]) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="widget-content widget-content-area blog-edit-section">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" id="title"
                                            value="{{ old('sub_title', $blogs->title) }}" name="title">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-xxl-12">
                                        ...
                                        <textarea name="description" class="form-control" id="description" cols="10" rows="5"> {{ old('description', $blogs->description) }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                            <a href="{{ route('blogs.photos', ['id' => $blogs->id, 'slug' => $blogs->slug]) }}"
