        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="dashboard" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('slider.all') }}"> View All </a>
                    </li>
                    <li>
            ...
            <li class="menu">
                <a href="#food" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-home">
                ...
                <ul class="collapse submenu list-unstyled" id="food" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('food.all') }}"> View All </a>
                    </li>
                    <li>
                        <a href="{{ route('food.create') }}"> Add Food Items </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="blog" data-bs-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{ route('blogs.create') }}"> Add Food Items </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="gallery" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('gallery.all') }}"> View All </a>
                    </li>
                    <li>
                        <a href="{{ route('gallery.create') }}"> Add Photos </a>
                    </li>
                </ul>
            </li>

            <li class="menu">
                <a href="#discount" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="feather feather-home">
                ...
                <ul class="collapse submenu list-unstyled" id="discount" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('discount.all') }}"> View All </a>
                    </li>
                    <li>
                        <a href="{{ route('discount.create') }}"> Add Discounts </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="reservation" data-bs-parent="#accordionExample">
                    <li>
                        <a href="{{ route('reservation.all') }}"> View All </a>
                    </li>
                    {{--  <li>
                        <a href="{{ route('discount.create') }}"> Add Discounts </a>
                    </li>  --}}
